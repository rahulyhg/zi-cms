<div class="row">
	...
	<div class="col-sm-9">
		...
		<div class="form-group">
			<textarea name="content" id="editor-post"></textarea>
		</div>
	</div>
	<div class="col-sm-3">
		<div class="box box-default">
			...
			<?php foreach ($list_cat as $lc): ?>
				<div class="checkbox">
					<label for="<?=$lc->name;?>"><input type="checkbox" name="categories[]" id="<?=$lc->name;?>" value="<?=$lc->id_category;?>"><?=$lc->name;?></label>
				</div>
			<?php endforeach; ?>
			</div>
		</div>
			...
			<div class="box-body">
				<div class="form-group">
					<select name="status" id="" class="form-control" required>
						<option value="">-- Publish or Draft --</option>
